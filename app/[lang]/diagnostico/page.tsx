...
export default function DiagnosticoPage() {
  ...
  // Solo permitir acceso a esta página en español. Si estamos en inglés, redirigir a /en/diagnosis
  if (lang === 'en') {
    if (typeof window !== 'undefined') {
      console.log("DiagnosticoPage: Redirigiendo de español a inglés");
      window.location.href = '/en/diagnosis';
    }
    return null;
  }
            ...
            >
              <div className="bg-white rounded-xl shadow-lg p-5 sm:p-8 border border-gray-100 relative overflow-hidden lg:sticky lg:top-24">
                ...
                <p className="text-lg sm:text-xl text-gray-600 mb-6 sm:mb-8 leading-relaxed">
                  Describe el problema actual en tu negocio y te recomendaré el servicio que mejor se adapte a tus necesidades.
                </p>
                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  >
                    ...
                    <div className="ml-3 sm:ml-4">
                      <h3 className="font-medium text-base sm:text-lg text-secondary">Describe tu problema</h3>
                      <p className="text-sm sm:text-base text-gray-600">Cuéntame qué está sucediendo en tu negocio actualmente</p>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="ml-3 sm:ml-4">
                      <h3 className="font-medium text-base sm:text-lg text-secondary">Recibe una recomendación</h3>
                      <p className="text-sm sm:text-base text-gray-600">Mi sistema analiza tu situación y sugiere el mejor servicio</p>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="ml-3 sm:ml-4">
                      <h3 className="font-medium text-base sm:text-lg text-secondary">Agenda una reunión</h3>
                      <p className="text-sm sm:text-base text-gray-600">Programa una consulta gratuita para hablar sobre soluciones</p>
                    </div>
                  </motion.div>
                </div>
                ...
                <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-gray-100">
                  <div className="flex items-center text-xs sm:text-sm text-gray-500">
                    ...
                    Tu información está segura y no la compartiré con terceros
                  </div>
                </div>
              </div>
            </motion.div>
